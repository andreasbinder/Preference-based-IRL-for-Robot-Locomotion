...
import numpy as np
import pandas as pd
from src.benchmark import plots
...
class InfoCollector():
    ...
    def add(self, info):
        self.dict_list_infos["distance"].append(info["distance_delta"])
        self.dict_list_infos["obs"].append(info["ob"])

    def __getitem__(self, key):
        return self.dict_list_infos[key]
