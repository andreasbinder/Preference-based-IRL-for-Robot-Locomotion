...
class Plots():
    ...
    def plot_head_trace(self, list_infos):
        ...
        # plt.show()
        plt.savefig(self.dir + self.env_name + '_plot_head_trace.pdf', dpi=300, bbox_inches='tight')
        plt.close('all')
    ...
    def plot_joint_angles(self, list_infos):
        ...
        plt.figure(figsize=(10, 4))
        plt.plot(data_x, data_y)
        plt.savefig(self.dir + self.env_name + '_plot_joint_angles.pdf', dpi=300, bbox_inches='tight')
        # plt.show()
    ...
    def plot_snake_gait(self, list_infos):
        ...
        for row in range(len(timesteps)):
            ...
            ax.plot(joints_x, joints_y, marker='o', markersize=3, color='b', linestyle='-', linewidth=1,
        ...
        # plt.show()
        plt.savefig(self.dir + self.env_name + '_snake_gait.png', dpi=300, bbox_inches='tight')
        plt.close('all')
    ...
    def plot_velocity_power_diagram(self, df, fname):
        ...
        ax = df.plot(x='velocity', y='total_power_mWh', kind='scatter', xlim=[0, 0.3], ylim=[0.0, 50.0],
                     figsize=(8, 5))  # , figsize=(9,6))
        ...
        # plt.show()fname
        plt.savefig(self.dir + '/' + fname + '_velocity_power_diagram.pdf', dpi=300, bbox_inches='tight')
        plt.savefig(self.dir + '/' + fname + '_velocity_power_diagram.png', dpi=300, bbox_inches='tight')
    ...
    def plot_energy_distance_diagram(self, df, fname):
        ...
        ax = df.plot(x='distance_delta', y='total_power_mWh', kind='scatter', xlim=[0.0, 10.0], ylim=[0.0, 50.0],
                     figsize=(8, 5))

        ax.set_xlabel("Distance [m]")
        ax.set_ylabel("Energy [mWh]")

        plt.savefig(self.dir + '/' + fname + '_energy_distance_diagram.pdf', dpi=300, bbox_inches='tight')
        plt.savefig(self.dir + '/' + fname + '_energy_distance_diagram.png', dpi=300, bbox_inches='tight')
    ...
    def plot_distance_bar_diagram(self, df):
        ...
        df2.plot(kind='bar')
        plt.savefig(self.dir + '/distance_diagram.pdf', dpi=300, bbox_inches='tight')
...
def plot_head_distance_figure(data_list, maindir, dir):
    ...
    for d in range(4):
        ...
        # data_title[d]
        plt.title(data_title[d], x=0.61, size=11, loc='center', horizontalalignment='center',
