...
def enjoy(env_id, seed, model_dir):
    with tf.device('/cpu'):
        ...
        #
        import torch
        triplet_path = "/gym_mujoco_planar_snake/prefnet/results/Mujoco-planar-snake-cars-angle-line-v1/improved_runs/vf_ensemble2_triplet_good_one/model_0"

        triplet_net = Net(27)
        triplet_net.load_state_dict(torch.load(triplet_path))

        pair_path = "/gym_mujoco_planar_snake/prefnet/results/Mujoco-planar-snake-cars-angle-line-v1/improved_runs/vf_ensemble5_pair/model_0"
