...
from pref_net.common.env_wrapper import prepare_env
...
class PPOAgent(object):
    ...
    def __init__(self, env, pi):
        ...
        self.env = env
        self.pi = pi
        self.learn = lambda num_timesteps: self._learn(self.env, self.pi,
...
if __name__ == '__main__':
    ...
    with tf.variable_scope(str(configs["variable_scope"])):
        ...
        with sess.as_default():
            ...
            from pref_net.common.data_util import generate_dataset_from_full_episodes
