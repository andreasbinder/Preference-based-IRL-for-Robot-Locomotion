...
def learn(env, policy_func, *,
    ...
    pi = policy_func("pi0", ob_space, ac_space)  # Construct network for new policy
    oldpi = policy_func("oldpi0" , ob_space, ac_space)  # Network for old policy
    ...
    while True:
        ...
        # MY
        dir = "//gym_mujoco_planar_snake/gym_mujoco_planar_snake/log/snake_test"
