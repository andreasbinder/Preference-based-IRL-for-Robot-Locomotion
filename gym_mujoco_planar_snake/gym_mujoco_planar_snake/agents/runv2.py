...
def evaluate_power_velocity(env_id):
    ...
    with tf.device('/cpu'):
        ...
        model_files = get_model_files('/home/andreas/LRZ Sync+Share/Training_Performances/openai-2020-06-01-21-57-16-490173/models/Mujoco-planar-snake-cars-angle-line-v1/ppo')
...
def main():
    ...
    if args.evaluate_power_velocity:
        ...
        env = args.env
        env = gym.make(env)
        #env.action_space = Box(low=-1.5,high=1.5,shape=(7,))
