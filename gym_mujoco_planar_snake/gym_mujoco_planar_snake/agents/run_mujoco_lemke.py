...
from baselines.common import tf_util as baselines_util
...
def evaluate_power_velocity(env_id):
    ...
    with tf.device('/cpu'):
        sess = baselines_util.make_session(num_cpu=1)
        sess.__enter__()
        env = gym.make(env_id)
...
def main():
    ...
    parser.add_argument('--num-timesteps', type=int, default=int(1500000))  # 1e6
    ...
    parser.add_argument('--sfs', help='save_frequency_steps', default=5000) # for mujoco
