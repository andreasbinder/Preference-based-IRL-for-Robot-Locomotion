...
def get_args():
    ...
    args.add_argument("--val_trajs", type=int, default=1000,
                      help="Number of trajectory pairs to generate before training to use as validation set")
    args.add_argument("--val_interval", type=int, default=500,
                      help="Run validation every val_interval training steps and save checkpoint")
    args.add_argument("--early_stopping_threshold", type=int, default=10,
    ...
    args.add_argument("--traj_length", type=int, default=50,
